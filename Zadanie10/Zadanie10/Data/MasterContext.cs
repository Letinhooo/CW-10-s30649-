...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdClient).HasName("PK__Client__C1961B332CD5B868");
        ...
        {
            entity.HasKey(e => new { e.IdClient, e.IdTrip }).HasName("PK__Client_T__C823521EC0BF3F0D");
        ...
        {
            entity.HasKey(e => e.IdCountry).HasName("PK__Country__F99F104D61F2B489");
            ...
            entity.HasMany(d => d.IdTrips).WithMany(p => p.IdCountries)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("IdCountry", "IdTrip").HasName("PK__Country___F02A5960034E2138");
        ...
        {
            entity.HasKey(e => e.IdTrip).HasName("PK__Trip__9B5492D1559C41AB");
